<template><div><h1 id="并查集" tabindex="-1"><a class="header-anchor" href="#并查集"><span>并查集</span></a></h1>
<hr>
<p><strong>ps : <code v-pre>有错误还请指教</code></strong></p>
<h3 id="定义-百度的" tabindex="-1"><a class="header-anchor" href="#定义-百度的"><span>定义(百度的)：</span></a></h3>
<ul>
...
<li>并（Union），代表合并</li>
<li>查（Find），代表查找</li>
<li>集（Set），代表这是一个以字典为基础的数据结构，它的基本功能是合并集合中的元素，查找集合中的元素</li>
<li>并查集的典型应用是有关连通分量的问题</li>
<li>并查集解决单个问题（添加，合并，查找）的时间复杂度都是O(1)O(1)</li>
<li>因此，并查集可以应用到在线算法中</li>
</ol>
<h3 id="python模板" tabindex="-1"><a class="header-anchor" href="#python模板"><span>python模板：</span></a></h3>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span># 创建并查集类</span></span>
...
<span class="line"><span>            self.father[x] = None</span></span></code></pre>

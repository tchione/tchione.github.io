<template><div><h1 id="privacy-and-regulation-blockchain" tabindex="-1"><a class="header-anchor" href="#privacy-and-regulation-blockchain"><span>Privacy And Regulation Blockchain</span></a></h1>
...
<h3 id="正文" tabindex="-1"><a class="header-anchor" href="#正文"><span>正文：</span></a></h3>
<ul>
<li>
...
<h3 id="秘钥生成" tabindex="-1"><a class="header-anchor" href="#秘钥生成"><span>秘钥生成：</span></a></h3>
<ul>
<li>追踪主管拥有用于追踪的秘钥对，一个用户有一个长期持有的秘钥对和许多用来执行交易的一次性秘钥对。收款方的一次性公钥是付款方生成的，只有特定的收款方可以使用自己的私钥恢复转账给他的交易的一次性私钥。在付款方生成一次性秘钥的同时，也生成一个标签，这个标签对于用户的长期公钥来进行一次可验证加密。标签（tag）中包含了追踪用户身份所需要的必要的信息。</li>
</ul>
<h3 id="交易生成" tabindex="-1"><a class="header-anchor" href="#交易生成"><span>交易生成：</span></a></h3>
<ul>
<li>付款方需要使用追踪主管的公钥加密一次性账户，并将其当做交易的一部分，矿工需要验证这段密文是否生成。只有追踪主管可以解密这段密文从而获得真实的付款方。</li>
</ul>
<h3 id="追踪一个付款方" tabindex="-1"><a class="header-anchor" href="#追踪一个付款方"><span>追踪一个付款方：</span></a></h3>
<ul>
<li>
<p>当需要进行追踪时，追踪主管可以是用自己的私钥解密交易中的加密信息，找到环中的真是用户，甚至可以解密标签得到用户的账户地址。</p>
</li>
<li>
<p>何时执行追踪交易是一个问题。</p>
<ul>
<li>Miracl library <a href="https://certivox.org/display/EXY/MIRACL" target="_blank" rel="noopener noreferrer">https://certivox.org/display/EXY/MIRACL</a></li>
</ul>
</li>
<li>
<p>研究方向：</p>
<ol>
<li>探索实现后量子时代的加密货币。</li>
<li>移除zk-snark中的可信第三方。</li>
<li>实现可追踪的加密货币（平衡匿名性和可追踪性）。</li>
</ol>
</li>
</ul>
</div></template>

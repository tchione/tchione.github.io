<template><div><h1 id="markdown" tabindex="-1"><a class="header-anchor" href="#markdown"><span>Markdown</span></a></h1>
...
<p class="hint-container-title">Frontmatter<hr class="footnotes-sep">
...
<Tabs id="51" :data='[{"id":"apple"},{"id":"banana"},{"id":"orange"}]' tab-id="fruit">
...
<p class="hint-container-title">自定义标题<hr class="footnotes-sep">
<section class="footnotes">
<ol class="footnotes-list">
<li id="footnote1" class="footnote-item"> <a href="#footnote-ref1" class="footnote-backref">↩︎</a></li>
</ol>
...
<details class="hint-container details"><summary>自定义标题<hr class="footnotes-sep">
<section class="footnotes">
<ol class="footnotes-list">
<li id="footnote1" class="footnote-item"> <a href="#footnote-ref1" class="footnote-backref">↩︎</a></li>
</ol>
...
<CodeTabs id="356" :data='[{"id":"pnpm"},{"id":"yarn"},{"id":"npm"}]' :active="2">
